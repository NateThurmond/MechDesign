   ...
   @return  jQuery object */
    ...
    $.widget("ui.resizable", $.ui.mouse, {
        ...
        _mouseStop: function (event) {
            ...
            if (this._helper) {
                ...
                left =
                    parseInt(that.element.css("left"), 10) + (that.position.left - that.originalPosition.left) || null;
    ...
    $.ui.plugin.add("resizable", "containment", {
        ...
        resize: function (event) {
            ...
            woset = Math.abs(
                that.sizeDiff.width + (that._helper ? that.offset.left - cop.left : that.offset.left - co.left)
            );
