 ...
 */
cryptoHash.prototype.hashPassword = function(password, callback) {
  
  // generate a salt for pbkdf2
  crypto.randomBytes(saltBytesToUse, function(err, salt) {
    if (err) {
      return callback(err);
    }

    crypto.pbkdf2(password, salt, iterationsToUse, hashBytesToUse,
      function(err, hash) {
      ...
      combined.writeUInt32BE(iterationsToUse, 4, true);
 ...
 */
cryptoHash.prototype.verifyPassword = function(password, combined, callback) {
